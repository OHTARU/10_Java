package com.mystudy.thread4_error2;
...
class ATM extends Thread {
	...
	synchronized void add(int money) {
		bank.money += money;
		System.out.println(Thread.currentThread().getName() + " - " + "입금: " + money + ", 잔액: " + bank.money);
	}

	synchronized void out(int money) {
		bank.money -= money;
		System.out.println(thredName + " - " + "출금: " + money + ", 잔액: " + bank.money);
	}
